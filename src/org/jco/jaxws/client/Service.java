 ...
 * 
 */
@WebServiceClient(name = "Service", targetNamespace = "http://tempuri.org/", wsdlLocation = "https://demoemision21.thefactoryhka.com.co/ws/v1.0/Service.svc?wsdl")
    ...
    extends javax.xml.ws.Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://demoemision21.thefactoryhka.com.co/ws/v1.0/Service.svc?wsdl");
    ...
    public IService getBasicHttpsBindingIService() {
        return super.getPort(new QName("http://tempuri.org/", "BasicHttpsBinding_IService"), IService.class);
    }
     ...
     */
    @WebEndpoint(name = "BasicHttpsBinding_IService")
    public IService getBasicHttpsBindingIService(WebServiceFeature... features) {
        return super.getPort(new QName("http://tempuri.org/", "BasicHttpsBinding_IService"), IService.class, features);
    }
